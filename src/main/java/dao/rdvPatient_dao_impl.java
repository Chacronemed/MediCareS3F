...
public class rdvPatient_dao_impl implements rdv_dao{

	private dao_factory dao_factory;

    public rdvPatient_dao_impl(dao_factory dao_factory) {
	...
	public List<rdv> getTodayMedcineRDV(int id_medcin){
		...
		Date today_date = new Date(new java.util.Date().getTime());
